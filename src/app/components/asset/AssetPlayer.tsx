...
// react icons
import { IoPlay, IoStop, IoVolumeHigh, IoVolumeMedium, IoVolumeLow, IoVolumeOff, IoVolumeMute } from "react-icons/io5";
...
const PlayerStatusView = (props: { status: PlayerStatus; currentTime: number }) => {
  // props
...
export default function AssetPlayer(props: AssetPlayerProps) {
  ...
  const [updatePlayerStatusTime, setUpdatePlayerStatusTime] = useState<number>(0);
        ...
        <div className="flex justify-center items-center relative">
          <video
            ...
            className={`w-full min-h-max ${
              isFullScreen ? "max-h-[calc(100lvh-10rem)]" : "max-h-[calc(100lvh-25rem)]"
            ...
            <div className="grid grid-cols-3 gap-3 justify-center items-center">
                ...
                <div className="flex gap-2">
                  ...
                  <div className="col-span-2">
                    <div className="flex h-full items-center">
                      <div className="tooltip" data-tip={mute ? "음소거 해제" : "음소거"}>
                        <Button className="" type="button" onClick={() => handleMute(!mute)}>
              ...
              <div className="col-span-1 text-right">
                <div className="flex justify-end gap-3">
                  <div>
                    <div className="tooltip" data-tip={isFullScreen ? "전체화면 종료" : "전체화면"}>
                      <Button className="" type="button" onClick={() => handleFullScreen(!isFullScreen)}>
                        {isFullScreen ? (
